<template>
<div :class="{ 'navbar-hide': showNavbar }" class="fixed navbar navbar-transition shadow-sm bg-slate-100 text-slate-800 font-['Work_Sans'] w-screen z-10 flex justify-between">
