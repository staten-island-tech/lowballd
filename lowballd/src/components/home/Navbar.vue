<template>
  <div
    ...
    class="sm:hidden navbar navbar-transition shadow-sm bg-slate-100 text-slate-800 font-['Work_Sans'] fixed w-screen z-10"
  >
        ...
        <div class="flex items-stretch">
          <a class="btn btn-ghost btn-sm rounded-btn">
            <svg
              ...
              data-prefix="far"
              data-icon="user"
              class="svg-inline--fa fa-user fa-w-14 inline-block w-3 mr-2 stroke-current"
              role="img"
