<template>
    <section class="w-60 sm:w-full sm:flex sm:flex-col sm:items-center capitalize ">
       <div class="sm:w-10/12 h-auto bg-gray-200 p-3 mb-5 rounded-xl ">
       ...
       <div class="sm:w-10/12 h-auto bg-gray-200 p-3 mb-5 rounded-xl ">
           <div class="flex flex-col mb-3">
               <FilterCategory filterCategory='Filler'/>
