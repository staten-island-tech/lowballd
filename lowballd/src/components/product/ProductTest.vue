        ...
        <div class="sticky top-0">
          <div class="flex flex-row">
            <div class="avatar pt-4">
              ...
              >
                <img
                  src="https://media-exp1.licdn.com/dms/image/C4E03AQGBvBlLy-uljw/profile-displayphoto-shrink_200_200/0/1610509335728?e=1648684800&v=beta&t=u9GCzx6GctOLBqOeRB1Z9Jv7aBXeb8XZrHCyvFBA-qw"
                />
              </div>
            </div>
            <div class="p-4">
            ...
            <div class="pb-6 prose max-w-none">
              ...
              <div class="flex flex-col w-full pt-12">
                ...
                <div class="flex justify-between">
                  ...
                  <h1 class="text-slate-700 text-right">
                    {{ prod.condition }}
                  </h1>
                </div>
                <div class="divider"></div>
          ...
          <form class="mt-8">
            ...
            <div class="flex mt-8">
              ...
              <button
                type="submit"
                class="block px-5 py-3 ml-3 text-xs font-medium text-white bg-blue-600 rounded hover:bg-pink-500"
              >
                Add to Cart
              </button>
            </div>
